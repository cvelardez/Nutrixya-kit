      ...
      <List type="unstyled">
        <li className="mb-1">
          <CardText className="fs-3">
            ...
            <span className="fw-bolder">215 kg/ha</span> de Urea
          </CardText>
        </li>
        ...
        <li className="mb-1">
          <CardText className="fs-3">
            ...
            <span className="fw-bolder">250 kg/ha</span> de Superfosfato triple
            de calcio SPS
          </CardText>
        </li>
        ...
        <li className="mb-1">
          <CardText className="fs-3">
            ...
            <span className="fw-bolder">60 kg/ha</span> de Cloruro de potasio
          </CardText>
        </li>
        ...
        <li className="mb-3">
          <CardText className="fs-3">
            ...
            <span className="fw-bolder">60 kg/ha</span> de Yeso
          </CardText>
        </li>
        ...
        <li className="mb-3">
          <CardText className="fs-3">
            ...
            <span className="fw-bolder">9 kg/ha</span> de Dolomita
          </CardText>
        </li>

        <li>
          <CardText className="fs-3">
            Costo para lograr el balance cero:{" "}
            <span className="fw-bolder">45 qq/ha</span> de maíz grano
          </CardText>
        </li>
      </List>
